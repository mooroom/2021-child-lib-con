...
const awardData = {
  award1: [
    ...
    },
    {
      ...
      description:
        '일본작가 초 신타의 "양배추 소년"을보고 상상한대로 하늘에 크게 나타나는 동물들의 모습에 재미를 느꼈습니다. 그래서 봄에 숲에서 활발히 뛰어노는 날다람쥐가 사이즈가 커져 하늘을 날면서 자기가 함께 타고 노는 모습을 그렸습니다.',
    },
    {
      id: 3,
      medal: medal2,
    ...
    },
    {
      ...
      description:
        "반짝이는 예쁜 무지개 물고기 안에 내가 들어가 있다. 바닷속에는 신기하고 예쁜 친구들이 많다. 나는 예쁜 무지개물고기와 함께 바다여행을 하면서 바다 친구들과 신나게 놀고 싶다. 그런데 진짜 무지개 물고기가 있을까?? ^^",
    },
    {
      id: 7,
      medal: medal3,
      ...
      title: "책 먹는 여우와 임주",
      description:
        "국립어린이청소년 도서관에서 임주와 여우가 점심 식사를 했다. 소금을 뿌려서 책과 콜라를 같이 먹었다.",
    },
    {
      id: 8,
      medal: medal3,
    ...
    },
    {
      ...
      title: "곤충은 내 친구",
      description:
        "<우리와 힘께 살아가는 곤충이야기>라는 책을 읽고 그 책의 주인공이 내가 된것같은 기분으로 그려 보았습니다. 저는 원래 곤충이 징그럽게 생겨서 엄청 무서워했는데 가족들과 캠핑을 하기 시작하면서 곤충에 대한 두려움이 조금씩 사라졌고 눈으로 곤충들을 관찰하면서 신비로운 곤충의 세계가 궁금하고 재미있었고 곤충을 그려보고 싶어서 이책을 선택했습니다.",
    },
    {
      id: 22,
      medal: medal4,
      ...
      description:
        "예전에 읽었던 꼬마 철학자 줄무늬 생쥐라는 동화책을 보았습니다. 꼬마철학자인 줄무늬 생쥐가 들려주는 이야기들이 너무 재미있었어요. 그래서 책을 읽는 생쥐의 방을 상상해 보았어요. 좋아하는 책과 치즈가 엄청 많고 벽시계도 치즈 모양입니다. 그리고 벽에는 치즈러브 라는 벽글씨도 적혀있어요. 저는 이런 창작동화를 좋아해요. 감사합니다.",
    },
    {
      id: 23,
      medal: medal4,
    ...
    },
    {
      ...
      description:
        '자는 <이상한 나라의 앨리스> 속 장면을 상상해 보았습니다. 앨리스가 토끼굴에서 떨어졌을 때, "난 분명히 지구 한가운데 쯤에 왔을거야" 라고 말했습니다. 그리고 심지어 졸기까지 했습니다. 하지만 만약 제가 앨리스와 같은 일을 겪었다면,정말 무서웠을 것 같습니다. 이런 그림을 상상해 보았습니다.',
    },
  ],
  award2: [
    {
